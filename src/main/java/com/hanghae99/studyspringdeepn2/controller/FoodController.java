...
public class FoodController {
    ...
    public List<Food> registerFoods(@PathVariable Long restaurantId, @Valid @RequestBody List<FoodRequestDto> requestDto){
        return foodService.registerFoods(restaurantId, requestDto);
    }
